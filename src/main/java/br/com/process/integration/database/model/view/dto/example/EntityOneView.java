...
public class EntityOneView extends RepresentationModel<EntityOneView> implements BeanView<EntityOneView> {
    ...
    public String toString() {
        return "EntityOneView{" +
        "idEntityOne=" + (idEntityOne != null ? idEntityOne.toString() : "null") + ", " +
        ...
        "prohibitedDateTime=" + (prohibitedDateTime != null ? prohibitedDateTime.toString() : "null") + ", " +
        "idEntityStatus=" + (idEntityStatus != null ? idEntityStatus.toString() : "null") + ", " +
        "idEntityTwo=" + (idEntityTwo != null ? idEntityTwo.toString() : "null") + ", " +
        "ativo=" + (ativo != null ? ativo.toString() : "null") + ", " +
        "startDateTime=" + (startDateTime != null ? startDateTime.toString() : "null") + ", " +
        "status=" + (status != null ? status.toString() : "null") + ", " +
        "color=" + (color != null ? color.toString() : "null") + ", " +
        "cost=" + (cost != null ? cost.toString() : "null") + ", " +
        "hex=" + (hex != null ? hex.toString() : "null") + ", " +
        "inclusionDate=" + (inclusionDate != null ? inclusionDate.toString() : "null") + ", " +
        "idEntityTree=" + (idEntityTree != null ? idEntityTree.toString() : "null") + ", " +
        ...
        "idEntityFour=" + (idEntityFour != null ? idEntityFour.toString() : "null") + ", " +
        "attribute=" + (attribute != null ? attribute.toString() : "null") + ", " +
        "fruit=" + (fruit != null ? fruit.toString() : "null") + ", " +
        "inclusionDateTime=" + (inclusionDateTime != null ? inclusionDateTime.toString() : "null") + ", " +
        "idEntityFive=" + (idEntityFive != null ? idEntityFive.toString() : "null") + ", " +
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(idEntityOne, that.idEntityOne) &&
        ...
        java.util.Objects.equals(cost, that.cost) &&
        ...
        java.util.Objects.equals(animal, that.animal) &&
        ...
        java.util.Objects.equals(fruit, that.fruit) &&
        java.util.Objects.equals(inclusionDateTime, that.inclusionDateTime) &&
        java.util.Objects.equals(idEntityFive, that.idEntityFive) &&
        java.util.Objects.equals(factor, that.factor) &&
        java.util.Objects.equals(reference, that.reference);
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(idEntityOne, age, birthDate, code, height, name, prohibitedDateTime, idEntityStatus, idEntityTwo, ativo, startDateTime, status, color, cost, hex, inclusionDate, idEntityTree, amount, animal, indicator, localDate, localDateTime, idEntityFour, attribute, fruit, inclusionDateTime, idEntityFive, factor, reference);
    }
}
